...
class GoodsController extends Controller
{
    ...
    public function add()
    {
    	...
    	$assign['cate_list'] = $this->getDataList($category,['status'=>Category2::USE_ABLE]);

    	$assign['cate_list'] = ToolsAdmin::buildTreeString($assign['cate_list'],0,0,'f_id');

    	//商品货号
    	$assign['goods_sh'] = ToolsAdmin::buildGoodsSn();
    ...
    public function doImport(Request $request)
    {
        ...
        foreach ($data as $key => $value) {
            ...
            $value['goods_sn'] = "JY".date("YmdHis",rand(10000,100000));
    ...
    public function export()
    {
        ...
        $head = ['cate_id','goods_name','goods_sn','goods_desc'];//excel的head头

        $exportData[] = ['cate_id','goods_name','goods_sn','goods_desc'];
