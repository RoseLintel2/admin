        ...
        <div class="panel-body panel-body-nopadding">
            ...
            <form class="form-horizontal form-bordered" action="/admin/goods/type/doAdd" method="post">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label">商品属性名字</label>
                    <div class="col-sm-6">
                        <input type="text" placeholder="商品属性名字" class="form-control" name="type_name" value="" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">商品属性状态</label>
                    <div class="col-sm-6">
